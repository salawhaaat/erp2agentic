...
**Pass 1: Voice** — Improve natural voice before fixing structure:
- Add opinions or reactions
- Vary sentence length and rhythm
- Use first person where appropriate
- Replace abstractions with specific details
- Allow mixed or imperfect viewpoints

**Pass 2: AI tells** — Remove patterns that make writing feel artificial:
- Inflated or vague language
- Fake depth without real meaning
- Overused structured phrasing patterns
- Generic corporate tone
- Repetitive sentence structures

**Pass 3: Audit** — Ask: "What still feels like AI in this text?" Write 1–2 lines, then revise once more.
